...
const { TEST_OWNER, CONNECTION, PAYER } = require("../const");
...
async function main() {
  ...
  console.log(`TEST_OWNER key: ${TEST_OWNER.publicKey}`)

  let tx = new Transaction();
  // add transfer instruction
  tx.add(
    SystemProgram.transfer({
      fromPubkey: TEST_OWNER.publicKey,
  ...
  let txhash = await CONNECTION.sendTransaction(tx, [TEST_OWNER, PAYER]);
